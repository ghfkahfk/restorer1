...
def main():
    ...
    scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, EPOCH, eta_min=1e-7)
    ...
    valueLoader = DataLoader(dataset=datasetValue, batch_size=BATCH_SIZE, shuffle=True, drop_last=True, num_workers=0,
                             pin_memory=True)
