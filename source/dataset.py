...
class MyTrainDataSet(Dataset):  # 训练数据集
    ...
    def __getitem__(self, index):
        ...
        inputImage=ttf.resize(inputImage,(500,500),interpolation=InterpolationMode.BILINEAR)
        targetImage = ttf.resize(targetImage, (500, 500), interpolation=InterpolationMode.BILINEAR)
...
class MyComDataSet(Dataset):  # 计算指标数据集
    def __init__(self, resultPathTrain, targetPathTrain):
        ...
        self.resultImages = os.listdir(resultPathTrain)  # 输入图片路径下的所有文件名列表
